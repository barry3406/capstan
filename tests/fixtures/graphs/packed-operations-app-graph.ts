...
export const packedOperationsAppGraph = {
  version: 1,
  domain: {
    key: "operations",
    title: "Operations Workspace",
    description: "A packed operations app that composes tenant and auth primitives."
  },
  packs: [
    {
      key: "tenant",
...
export default packedOperationsAppGraph;
