...
export default function ArchitecturePage() {
  return createElement(DocsLayout, null,
    ...
    createElement("p", null,
      "Capstan's architecture is organized around three pillars -- AI agents, full-stack web, and self-evolution -- unified by five kernels and a shared source of truth. ",
      "This page describes the conceptual model, the current package boundaries, and the golden loop that ties them together."
    ),

    // Unified Architecture
    createElement("h2", null, "Unified Architecture"),
    createElement("p", null, "Capstan serves two primary roles from a shared Bun-native runtime:"),
...
`                        Capstan
  ...
  Harness Mode       Auth/OAuth     Utility Feedback
    ...
    createElement("ul", null,
      createElement("li", null, "Task lifecycle and the smart agent loop"),
      createElement("li", null, "Tool execution with validation, timeout, and concurrent dispatch"),
      createElement("li", null, "Shell, browser, and runtime coordination"),
      createElement("li", null, "Memory, compression, and context management"),
      createElement("li", null, "Approvals, interventions, and checkpoints"),
      createElement("li", null, "Event streaming and evolution capture")
    ),
    ...
    createElement("h3", null, "Agent Layer"),
    createElement("table", null,
      createElement("thead", null,
        createElement("tr", null,
      ...
      createElement("tbody", null,
        createElement("tr", null,
          ...
          createElement("td", null, "Smart agent loop, tools, skills, memory, evolution, compression, harness mode, durable/recurring execution")
        ),
        createElement("tr", null,
          createElement("td", null, createElement("code", null, "@zauso-ai/capstan-agent")),
          createElement("td", null, "LLM providers, machine surfaces (MCP, A2A, OpenAPI, agent manifest), LangChain integration")
        ),
        createElement("tr", null,
          createElement("td", null, createElement("code", null, "@zauso-ai/capstan-cron")),
          createElement("td", null, "Scheduled tasks and background agent jobs")
        )
      )
    ),
    ...
    createElement("table", null,
      ...
      createElement("tbody", null,
        ...
        createElement("tr", null,
          createElement("td", null, createElement("code", null, "@zauso-ai/capstan-ops")),
          createElement("td", null, "Semantic operations kernel (events, incidents, snapshots, SQLite persistence)")
        )
      )
    ),
