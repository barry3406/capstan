...
// Checks: HMAC-SHA256 signature, expiration`
    ...
    createElement("p", null, "API keys are designed for AI agent authentication. They use a prefix-based lookup scheme for efficient database queries and SHA-256 hashing for secure storage."),
