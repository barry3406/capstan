...
// Returns rows ordered by cosine similarity`
    ...
    createElement("h2", null, "Agent Evolution Persistence"),
    createElement("p", null,
      "The ", createElement("code", null, "SqliteEvolutionStore"),
      " from ", createElement("code", null, "@zauso-ai/capstan-ai/evolution"),
      " uses SQLite to persist agent evolution data -- experiences, strategies, and evolved skills. This enables agents built with ",
      createElement("code", null, "createSmartAgent"),
      " to learn and improve across runs."
    ),
...
const agent = createSmartAgent({
  ...
  evolution: {
    ...
    createElement("p", null,
      "The store persists three entity types: ",
      createElement("strong", null, "experiences"),
      " (run trajectories with goals, outcomes, and tool sequences), ",
      createElement("strong", null, "strategies"),
      " (distilled patterns with utility scores), and ",
      createElement("strong", null, "skills"),
      " (high-utility strategies promoted to reusable agent skills). For testing, use ",
      createElement("code", null, "InMemoryEvolutionStore"), " instead."
    ),
