...
export interface PageRuntimeOptions {
  ...
  /** Action result from form POST — threaded into ActionContext during SSR */
  actionResult?: unknown;
  /** Submitted form data from POST — threaded into ActionContext during SSR */
...
function buildRenderOptions(
  ...
  if (options.actionResult !== undefined) renderOptions.actionResult = options.actionResult as NonNullable<RenderPageOptions["actionResult"]>;
  if (options.actionFormData !== undefined) renderOptions.actionFormData = options.actionFormData;
